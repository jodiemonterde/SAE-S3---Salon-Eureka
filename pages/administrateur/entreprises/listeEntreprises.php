...
<html lang="en">
    <head>
        ...
        <link rel="stylesheet" href="./EntrepriseAdmin.css">
        <link rel="stylesheet" href="../../../css/navbars.css">
        <link rel="stylesheet" href="filtreAdmin.css">
        <title>pas dev</title>
    </head>
    <body>
        <!-- Navbar du haut -->
        ...
        <div class="container mt-2">
            <div class="row d-flex align-items-center h-100">
                ...
                <div class="col-md-6 col-12 order-md-1 order-2">
                    ...
                    <p>Voici toutes les entreprises présentes au salon Euréka cette année. Cliquez sur l’une d’elle pour voir tous les étudiants qui veulent un rendez-vous avec celle-ci !</p>
                </div>
            </div>
                ...
                <div id="collapse<?php echo $ligne['company_id']?>" class="accordion-collapse collapse" aria-labelledby="heading<?php echo $ligne['company_id']?>" data-bs-parent="#listeEntreprise">
                    <div class="accordion-body">
                        <div class="row">
                            ...
                            <?php
                                $requete = getIntervenant($pdo, $ligne['company_id']);
                                foreach($requete as $row){
                            ?>
                            <div class="col-12"><?php echo $row['Speaker.name']?></div>
                            <div class="col-2"><?php echo $row['Field.name']?></div>
                            <?php
                                }
                            ?>
                        </div>
